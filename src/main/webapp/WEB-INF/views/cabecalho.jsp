			...
			<div id="header-content">
				<nav id="main-nav" >
					...
					<security:authorize access="hasRole('ROLE_ADMIN')">
						...
						<li><a href="${s:mvcUrl('PSC#pedidos').build() }" rel="nofollow"><fmt:message key="menu.pedidos"/></a></li>
						<li><a href="${s:mvcUrl('UC#lista').build() }" rel="nofollow"><fmt:message key="menu.usuarios"/></a></li>
